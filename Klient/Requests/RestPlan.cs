...
namespace Dziennik_Szkolny
{
    ...
    class RestPlan
    {
        ...
        /// <param name="day">dzień, z którego ma zostać pobrany plan</param>
        ...
        public async Task<string> makeRequestFunction(string uuid, int day, string url)
        {
            ...
            postData += "&day=" + Uri.EscapeDataString(day.ToString()); // Wypełenie danych do wysłania w postaci formualarza
